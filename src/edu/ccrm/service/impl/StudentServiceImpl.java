...
public class StudentServiceImpl implements StudentService {
    ...
    private EnrollmentService enrollmentService; // late injection
    ...
    // Setter injection to solve circular dependency
    ...
    public double calculateGpa(String studentId) {
        ...
        if (enrollmentService == null) {
            throw new IllegalStateException("EnrollmentService not initialized");
        }
